...
def batch_gradient(M, b, M2, b2, OL, b3, input, target, t, iter):
    ...
    return dLdW, dLdb, dLdW2, dLdb2, dLdOL, dLdb3, loss

def batch_descent(M, b, M2, b2, OL, b3, dLdW, dLdb, dLdW2, dLdb2, dLdOL, dLdb3, n):
    M = gradient_descent(M, dLdW, n)#Weights of 1st Layer altered
